    ...
    def forward(self, hidden_states, inference_params=None):
        ...
        if self.use_fast_path and inference_params is None:  # Doesn't support outputting the states
            if self.bimamba_type == "v1":
                ...
                if self.as_decoder:
                    return F.linear(rearrange(out, "b d l -> b l d"), self.out_proj.weight, self.out_proj.bias), F.linear(rearrange(out_b.flip([-1]), "b d l -> b l d"), self.out_proj.weight, self.out_proj.bias)
